...
val conventionRoom = Plugin("convention.room")
val conventionKotlinSerialization = Plugin("convention.serialization")
val conventionKotlinJvm = Plugin("convention.kotlin-jvm")
val conventionKotlinJvmAndroid = Plugin("convention.kotlin-jvm-android")
val conventionKsp = Plugin("convention.ksp")
val conventionSigning = Plugin("convention.signing")
val conventionGradleSecrets = Plugin("convention.gradle-secrets")
